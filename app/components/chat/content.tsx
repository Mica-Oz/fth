...
const ChatContent: React.FC<ContentProps> = ({ chatHistory }) => {
  const chatBodyRef = useRef<HTMLInputElement>(null);

  useEffect(() => {
    // Scroll to the bottom of the chat body when it updates
    if (chatBodyRef.current) {
      chatBodyRef.current.scrollTop = chatBodyRef.current.scrollHeight;
    }
  }, [chatHistory]);
  return (
    <div ref={chatBodyRef} className="chat-content">
      <div className="message-cont bot">
        ...
        <div className="chat-message bot">
          <p>
            Hi there! - I am the FreeTaxHistory.com Chatbot, here to assist you
      ...
      {/* <div className="message-cont user">
        <div className="chat-message user">
          <p>Lorem ipsum dolor sit labore commodi!</p>
        </div>
