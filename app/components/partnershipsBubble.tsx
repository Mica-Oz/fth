  ...
  return (
    <>
      <div
        ...
        data-aos-delay="150"
      >
        <div className="header-bubble">Partnerships</div>
        <div
          className="box-pic"
          id="contactBub"
          style={{
        ...
        <div className="square">
          <div className="cont">
            ...
            <p>
              <strong>Tax Industry Professionals</strong> are always welcome to
              contact us in regards to partnerships. We are rapidly growing and
              our always interested in adding partners and affiliates to our
              team.
            </p>
