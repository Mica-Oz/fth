    ...
    <>
      ...
      >
        ...
        <div className="squares" data-aos="fade-right" data-aos-delay="300">
          <div className="square" id="square1">
            ...
            <div className="box-header-back"></div>
            <div className="box-foot-back"></div>
        ...
        <div className="top-big-square">
          ...
          <div className="square">
            <div className="cont">
              ...
              <p>
                Whether you have an open IRS audit, outstanding balances with
                the IRS, unfiled tax years, an incomplete tax resolution case,
                or you’re just curious,{" "}
                <strong>
                  anyone can benefit from knowing their tax history.
                </strong>
              </p>
          ...
          <div className="row-1">
            ...
            >
              ...
              <div className="thing-cont active">
                ...
                <div className="thing-back"></div>
              </div>
              <div className="thing-circle">
                <div className="thing-circle-active"></div>
              </div>
            ...
            >
              ...
              <div className="thing-circle"></div>
              <div
      ...
      <div className="sign-up" style={{ backgroundImage: `url(${blur2.src})` }}>
        <div className="cont2">
          ...
          <div className="row-4">
            <div className="app-btn apple" style={{ marginRight: "15px" }}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="35"
                height="35"
        ...
        <div className="big-square sign-up-square">
          <div className="square">
            <div className="box-front">
              <h5>
      ...
      >
        ...
        <div className="cont">
          ...
          <div className="row-3">
            <h4>FreeTaxHistory App Coming Soon:</h4>
          </div>
          <div className="row-4">
            <div className="app-btn apple" style={{ marginRight: "15px" }}>
              <svg
          ...
          <div className="row-7">
            <p>All Rights Reserved. FreeTaxHistory.com © 2025.</p>
          </div>
        </div>
      </div>
    </>
